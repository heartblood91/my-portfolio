...
const Education = () => {
  const contents = React.useMemo(() => [
    { year: '2018-2020', title: 'Udemy', subTitle: 'Formation en ligne', body: <UdemyContent /> },
    { year: '2020', title: 'Cyberini', subTitle: 'Formation Online Sécurité Informatique', body: <CyberiniContent /> },
    { year: '2009 - 2012', title: 'Université Paris Descartes', subTitle: 'Licence de Psychologie', body: <ParisDescartesContent /> },
  ], [])

  const elements = React.useMemo(() => {
    return contents.map((content) => {
      return (
        <div className='col-lg-4 col-md-6' key={content.title}>
          <EducationItem
            year={content.year}
            title={content.title}
...
/// Transformer le tout avec un interpreteur de balise
const UdemyContent = React.memo(() => {
  return (
    <div>
      <p>
...
const CyberiniContent = React.memo(() => {
  return (
    <div>
...
const ParisDescartesContent = React.memo(() => {
  return (
